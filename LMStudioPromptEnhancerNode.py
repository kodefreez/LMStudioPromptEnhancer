    ...
    def INPUT_TYPES(s):
        ...
        return {
            ...
            "optional": {
                ...
                "action_pose": (["default", "random", "adjusting glasses", "arms crossed", "crouching", "dancing", "fighting stance", "hands in pockets", "heroic pose", "holding an object", "jumping", "leaning against a wall", "looking over shoulder", "piloting a vehicle", "pointing", "reading a book", "reaching out", "running", "sitting", "standing", "walking", "wide_stance", "writing"],),
